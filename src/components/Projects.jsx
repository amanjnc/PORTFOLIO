		...
		>
			<div className='flex flex-col sm:-mx-4 sm:flex-row'>
				...
				<div className='mt-4 sm:mx-4 sm:mt-0'>
					<h1 className='text-xl font-semibold font-poppins text-gray-200 capitalize md:text-2xl'>
						{props.title}
					</h1>
			...
			<p className='mt-8 font-poppins text-[#414551]'>{props.content}</p>
			...
			<div className='flex mt-4 -mx-2'>
				...
				{props.link && (
					<a href={props.link} target='_blank' rel='noopener noreferrer'>
						<BsLink45Deg
							size='2rem'
							className='text-white hover:text-[#8dbbeb] mr-1'
						/>
					</a>
				)}
				{props.figma && (
					<a href={props.figma} target='_blank' rel='noopener noreferrer'>
						<FontAwesomeIcon
							size='2x'
							icon={faFigma}
							className='text-white mr-1 hover:text-[#8dbbeb] ml-1'
						/>
					</a>
				)}
			</div>
...
// Projects component remains unchanged
const Projects = () => {
	return (
